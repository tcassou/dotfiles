...
VAGRANT=$(if [ `users` == "vagrant" ]; then echo '1'; else echo '0'; fi)
...
alias pm='up; cd $PM_ROOT/admin && bundle install; mig'
## Vagrant
...
alias ipython='cd $PM_ROOT/algo; PYTHON_ENV="production_readonly" PYTHONDONTWRITEBYTECODE=1 ipython'
## Devtools
